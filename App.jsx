...
export default function App() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-600 to-green-800 flex flex-col items-center justify-center text-white p-6">
      {/* Logo y título */}
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-extrabold">
          Calculadora de Crédito <span className="text-orange-400">Comionline</span>
        </h1>
